        ...
        GroupActionContainer(
          ...
          actionList: [
            ...
            GroupAction(
              ...
              icon: c.CupertinoIcons.right_chevron,
              onTap: () async {
                String url = "https://github.com/coder-freak/star_book/blob/master/PRIVACY%26POLICY.md";
                try {
            ...
            GroupAction(
              ...
              icon: c.CupertinoIcons.right_chevron,
              onTap: () async {
                String url = "https://github.com/coder-freak/star_book/blob/master/LICENSE";
                try {
                  if (await canLaunch(url)) await launch(url);
                } catch (e) {
                  // print("Url Exception , ${e.toString()}");
